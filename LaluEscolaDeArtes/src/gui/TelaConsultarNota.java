...
public class TelaConsultarNota {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaConsultarNota window = new TelaConsultarNota();
	...
	private void initialize() {
		...
		frmLaluAcademiaDe.setIconImage(Toolkit.getDefaultToolkit().getImage(TelaConsultarNota.class.getResource("/com/sun/java/swing/plaf/windows/icons/Computer.gif")));
